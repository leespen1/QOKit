...
def main(args):
    ...
    graphs = [nx.barabasi_albert_graph(n, m, seed=seed) for seed in seeds]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--edgesPerNode", type=int, required=True, help="Number of edges to attach from a new node to existing nodes (must satisfy 1 <= m < n).")
