#=
E027 — Synthetic-noise control: does generic noise on exact N reproduce the
sampled-N gain?

E026 showed the sampled-N advantage (under the normalized objective) is
...
objectives. Reference rows: exact N and one S=10 sampled draw (E026 stream).

Run: JULIA_NUM_THREADS=auto julia --project research/experiments/027_synthetic-noise-control/run.jl (~15 min)
Smoke: E27_SMOKE=1 ...
=#
