#=
E019 — Toward closing the density law: an exact lower bound on the
...
Run: julia --project research/experiments/019_conditioning-correction/run.jl  (~2 min)
=#
...
const SEED = 20260611                        # same instances as E002/E004/E014/E018
const NS   = [12, 14]
const INST = 10
