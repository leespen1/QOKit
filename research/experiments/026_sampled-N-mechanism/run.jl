...
E025 found that sampled N (S=10) + normalized objective beats exact N +
...
Run: JULIA_NUM_THREADS=auto julia --project research/experiments/026_sampled-N-mechanism/run.jl (~20 min)
Smoke: E26_SMOKE=1 ...
=#
...
const SEED  = 20260611             # same instance seeds as E025
const N_V   = 12
