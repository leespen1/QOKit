...
**Question:** E022 showed the normalized proxy overpredicts the objective
...
Normalization (E020) already removes the norm-visible part of the leakage
...
ARGMAX. The winner's-curse component of the overprediction (E022) is a
...
Reproduce: `JULIA_NUM_THREADS=auto julia --project research/experiments/023_bias-corrected-objective/run.jl` (~12 min).
