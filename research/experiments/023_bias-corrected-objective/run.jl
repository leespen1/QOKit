#=
E023 — Is the proxy's overprediction predictable, and does correcting it
help parameter setting?

E022 found the normalized proxy objective OVERPREDICTS the true objective
...
Run: JULIA_NUM_THREADS=auto julia --project research/experiments/023_bias-corrected-objective/run.jl  (~12 min)
Smoke: E23_SMOKE=1 ...
=#
