#=
E040 — Do the headline parameter-space findings persist at n = 16?

E014/E033 (argmax displacement predicts regret), E036 (normalization halves
depth regret), and E038 (signed anatomy: uniform overprediction, winner's
...
Run: JULIA_NUM_THREADS=auto julia --project research/experiments/040_n16-stability/run.jl  (long: ~1-2 h)
Smoke: E24_SMOKE=1 ...
=#
