...
**Question:** E014/E033 (argmax displacement predicts regret), E036
(normalize at depth), and E038 (signed anatomy) were established at
...
1. **Argmax displacement still predicts regret**: pooled Spearman
   ...
   similar here (0.85/0.81), but E033 showed pooled fidelity correlations
...
One stability sentence added to the E014/E033 paragraph and one to the
normalization paragraph in section 5.4.

Reproduce: `JULIA_NUM_THREADS=auto julia --project research/experiments/040_n16-stability/run.jl` (~1 h).
