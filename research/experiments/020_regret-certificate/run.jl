#=
E020 — From state error to regret: a two-point leakage certificate.
...
Run: JULIA_NUM_THREADS=auto julia --project research/experiments/020_regret-certificate/run.jl  (~10 min)
Smoke: E20_SMOKE=1 ...
=#
