...
paper's error calculus bounds STATE error while its own E014/E017 show
...
Reproduce: `JULIA_NUM_THREADS=auto julia --project research/experiments/020_regret-certificate/run.jl`
