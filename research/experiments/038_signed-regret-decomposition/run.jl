#=
E038 — Why is the two-point certificate 10x loose? The exact signed
...
where margin >= 0 by definition of theta-hat. The E036 certificate replaces
...
Run: JULIA_NUM_THREADS=auto julia --project research/experiments/038_signed-regret-decomposition/run.jl  (~10 min)
Smoke: E22_SMOKE=1 ...
=#
