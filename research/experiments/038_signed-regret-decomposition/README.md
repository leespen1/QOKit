...
**Question:** E036's two-point certificate is honest but ~10x loose. Where
...
Reproduce: `JULIA_NUM_THREADS=auto julia --project research/experiments/038_signed-regret-decomposition/run.jl` (~10 min).
