...
- New remark in section 4: the whole section extends to integer-weighted
  MaxCut with the replacements above (verified, E037); continuous weights
...
Reproduce: `JULIA_NUM_THREADS=auto julia --project research/experiments/037_weighted-maxcut/run.jl` (~4 min).
