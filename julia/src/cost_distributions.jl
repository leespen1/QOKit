...
"""
function gpu_get_real_distribution_from_costs(
    costs::AbstractVector{<:Real},
    num_edges::Integer,
    num_vertices::Integer;
    max_num_edges::Integer=0
    ...
    # Grid dimensions: total threads = num_bitstrings^2
...
function _real_distribution_kernel!(
    ...
    if idx <= num_pairs
        # Convert linear index to (x, y) pair (0-indexed)
        ...
        # Get cost of y (costs array is 1-indexed)
        cost_y = costs[y + 1]
...
"""
function gpu_get_homogeneous_distribution_from_costs_direct(
    costs::AbstractVector{<:Real},
    num_edges::Integer,
    num_vertices::Integer;
    max_num_edges::Integer=0
    ...
    # Reshape for broadcasting: (cost_axis_size, 1, 1)
