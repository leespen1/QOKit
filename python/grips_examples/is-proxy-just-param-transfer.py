...
```
/home/kerger/code/QOKit/python/qokitvenv/bin/python python/grips_examples/is-proxy-just-param-transfer.py \
  ...
  --num-beta-grid 20 \
  --landscape-m-max 25 \
  --output-dir python/grips_examples/results/param_transfer_medium
```
