...
import grips.QAOA_simulator as qs
...
optimizer_method = spsa_for_scipy  # classical optimizer to use
...
qaoa_result = qs.QAOA_run(ising_model, N, p, init_gamma, init_beta, optimizer_method=optimizer_method)
