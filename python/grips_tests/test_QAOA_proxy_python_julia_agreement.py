...
return_dict_julia = QAOA_proxy_optimize_gamma_beta(triangle_proxy_julia, gammas, betas, optimizer_method="Nelder-Mead")
return_dict_python = QAOA_proxy_optimize_gamma_beta(triangle_proxy_python, gammas, betas, optimizer_method="Nelder-Mead")
